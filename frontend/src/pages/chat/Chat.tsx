...
import Paulch from '../../assets/Paulch.png'
...
const Chat = () => {
  ...
  useEffect(() => {
    if (!appStateContext?.state.isLoading) {
      setLogo(ui?.chat_logo || ui?.logo || Paulch)
    }
                  ...
                  <CommandBarButton
                    ...
                    styles={{
                      ...
                      root: {
                        color: '#FFFFFF',
                        background:
                          'radial-gradient(109.81% 107.82% at 100.1% 90.19%, #00FF9C 33.63%, #B6FFA1 70.31%, #FEFFA7 100%)'
                      },
                      rootDisabled: {
                        background: '#F0F0F0'
                      }
